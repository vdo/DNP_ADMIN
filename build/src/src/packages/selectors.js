...
export const getPackagesToBeUpgraded = state => {
  ...
  const _packages = packages(state);
  // _packages = [
  //   {
  //     isCORE: true,
  //     isDNP: false,
